...
import { availableCommands, availableCommandsForDesktop, commandText, commandDescriptions, indentCreatedByCommand, doesCommandSupportTargetOptions, canCommandSelect, canCommandFind } from '../../common/command'
...
class DashboardEditor extends React.Component {
        ...
        <Menu onClick={handleClick} style={menuStyle} mode="vertical" selectable={false}
          items={[
            ...
            },
            {
              ...
              label: (
                <>
                  <span>{isBreakpoint ? 'Kesme noktasını kaldır' : 'Kesme noktası ekle'}</span>
                </>
              )
            },
            {
            ...
            },
            {
              ...
              label: (
                <>
                  <span>Buradan itibaren oynat</span>
                </>
              )
            },
            {
              ...
              label: (
                <>
                  <span>Buradan itibaren oynat ve değişkenleri koru</span>
                </>
              )
            },
            {
              ...
              label: (
                <>
                  <span>Bu noktaya kadar oynat</span>
                </>
              )
            },
            {
              ...
              label: (
                <>
                  <span>Buradan itibaren kaydet</span>
                </>
              ),
  ...
  renderNormalTable(dataSource) {
    ...
    const columns = [
      ...
      { title: 'Hedef', dataIndex: 'target', key: 'target', width: 250, ellipsis: true },
      { title: 'Değer', dataIndex: 'value', key: 'value', ellipsis: true },
      {
        title: 'İşlem',
        key: 'ops',
        width: 80,
                ...
                children: (
                  <>
                    ...
                    <div className="form-group fields-wrapper" style={{ marginBottom: 0 }}>
                      <Form>
                        <Form.Item label="Komut" labelCol={{ span: 4 }} wrapperCol={{ span: 20 }}>
                          <div className="flex-row" ref={this.cmdInputRef}>
                            <Select
                              ...
                              filterOption={(input, { key }) => {
                                ...
                                const cmdMatch = key.toLowerCase().indexOf(lowerInput) !== -1
                                const descMatch = commandDescriptions[key] && commandDescriptions[key].toLowerCase().indexOf(lowerInput) !== -1
                        ...
                        <Form.Item label="Hedef" className="target-row" labelCol={{ span: 4 }} wrapperCol={{ span: 20 }}>
                          <div className="flex-row">
                            ...
                            >
                              {isInspecting
                                ? (<span>{(selectedCmdIsVisualSearch ? '👁' : '') + 'İptal'}</span>)
                                : (<span>{(selectedCmdIsVisualSearch ? '👁' : '') + 'Seç'}</span>)
                              }
                            </Button>
                            <Button
                            ...
                            >
                              {(selectedCmdIsVisualSearch ? '👁' : '') + 'Bul'}
                            </Button>
                          </div>
                        </Form.Item>
                        <Form.Item label="Değer" labelCol={{ span: 4 }} wrapperCol={{ span: 20 }}>
                          <Input
                            disabled={!isCmdEditable}
                        ...
                        <Form.Item label="Açıklama" labelCol={{ span: 4 }} wrapperCol={{ span: 20 }} style={{ marginBottom: 0 }}>
                          <Input
                            disabled={!isCmdEditable}
